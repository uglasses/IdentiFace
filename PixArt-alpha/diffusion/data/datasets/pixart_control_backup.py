...
class InternalDataControl(Dataset):
    def __init__(self,
        ...
        self.control_feat_samples = []  # Kept for backward compatibility; actually stores features for all modalities
        self.control_feat_samples_2 = []  # Second-branch control feature paths (aligned with control_feat_samples)
    ...
    def getdata(self, index):
        ...
        controlnet_feat_path = self.control_feat_samples[index]  # Renamed to reflect generality
        if self.zero_text_training:
            use_long = False
